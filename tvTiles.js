...
let topURL = 'https://api.themoviedb.org/3/search/tv?api_key=a86f1ad1d039e27d489a36607616522f&language=en-US&query='+srch+'&page=1&include_adult=false';
if(srch==null){
    topURL = 'https://api.themoviedb.org/3/discover/tv?api_key=a86f1ad1d039e27d489a36607616522f&with_genres='+genID;
}
getLatest(topURL);
